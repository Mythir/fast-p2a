...
/*
 * Class copied and adjusted from DefaultV2ValuesWriterFactory in the Parquet-MR source code.
 * If an instance of this class is passed to the ParquetWriter it will write a Parquet file
 * with an encoding as specified by the ValuesWriter classes listed below.
 */

public class CustomV2ValuesWriterFactory implements ValuesWriterFactory {
