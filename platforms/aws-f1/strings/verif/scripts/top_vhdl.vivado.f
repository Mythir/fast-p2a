...
${PTOA_HARDWARE_DIR}/vhdl/encoding/delta/CharBuffer.vhd
...
${PTOA_HARDWARE_DIR}/vhdl/encoding/delta/DeltaLengthDecoder.vhd
...
${PTOA_DIR}/examples/str/hardware/ptoa_wrapper_delta_length_uncompressed.vhd
